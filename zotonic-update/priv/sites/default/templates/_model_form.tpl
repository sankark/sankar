  {% with edit_rule as r %}    
  {% wire id="model_form" type="submit" postback="add_model" delegate="resource_models" %}
...
<input type="text" id="model_name" name="model_name" value="{{ r.model_name }}"/>
 <label for="message">{_ Model Definition _}</label>
	    <textarea name="model_def" id="model_def" cols="120" rows="25" class="span12 intro"  >{{r.model_def}}</textarea><br>
